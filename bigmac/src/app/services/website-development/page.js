        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-8">
          ...
          <nav>
            <ul className="flex space-x-8 text-lg font-medium">
              <li>
                <a href="#" className="hover:text-green-200 transition duration-300">Privacy Policy</a>
              </li>
              <li>
                <a href="#" className="hover:text-green-200 transition duration-300">Terms of Service</a>
              </li>
              <li>
                <a href="/WebsiteContactUs/Home" className="hover:text-green-200 transition duration-300">Contact Us</a>
              </li>
            </ul>
          </nav>
        </div>
