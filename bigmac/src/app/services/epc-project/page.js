        ...
        <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-black via-gray-900 to-black text-white px-8">
          ...
          <ul className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl">
            <li className="p-10 bg-gradient-to-r from-black via-gray-800 to-gray-900 rounded-2xl shadow-xl border border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-2xl transform hover:scale-105">
              <h2 className="text-3xl font-semibold mb-4 text-white"> Project Planning</h2>
              <p className="text-gray-300">Ensuring your website looks amazing on any device.</p>
            </li>
            <li className="p-10 bg-gradient-to-r from-black via-gray-800 to-gray-900 rounded-2xl shadow-xl border border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-2xl transform hover:scale-105">
              <h2 className="text-3xl font-semibold mb-4 text-white">Engineering Solutions</h2>
              <p className="text-gray-300">We build scalable and secure online stores.</p>
            </li>
            <li className="p-10 bg-gradient-to-r from-black via-gray-800 to-gray-900 rounded-2xl shadow-xl border border-green-200 hover:border-green-400 transition-all duration-300 hover:shadow-2xl transform hover:scale-105">
              <h2 className="text-3xl font-semibold mb-4 text-white"> Construction Management</h2>
          ...
          <div className="container mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-10 bg-gradient-to-b from-gray-900 to-black rounded-2xl shadow-xl border border-gray-700 hover:border-green-200 transition-all transform hover:scale-105 hover:shadow-2xl">
                <h3 className="text-3xl font-semibold mb-4 text-white">Project Planning</h3>
                <p className="text-gray-300">Talent Acquisition</p>
              </div>
              <div className="p-10 bg-gradient-to-b from-gray-900 to-black rounded-2xl shadow-xl border border-gray-700 hover:border-green-200 transition-all transform hover:scale-105 hover:shadow-2xl">
                <h3 className="text-3xl font-semibold mb-4 text-white">Engineering Solutions</h3>
                <p className="text-gray-300"> Payroll Management</p>
              </div>
              <div className="p-10 bg-gradient-to-b from-gray-900 to-black rounded-2xl shadow-xl border border-gray-700 hover:border-green-200 transition-all transform hover:scale-105 hover:shadow-2xl">
                <h3 className="text-3xl font-semibold mb-4 text-white"> Construction Management</h3>
