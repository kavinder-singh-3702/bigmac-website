            ...
            <div>
              ...
              <form className="relative mt-8 sm:mt-12">
                ...
                <div className="sm:absolute flex sm:right-1.5 sm:inset-y-1.5 mt-4 sm:mt-0">
                  <button className="inline-flex items-center justify-center w-full px-5 py-5 text-sm font-semibold tracking-widest text-black uppercase bg-white rounded-full sm:w-auto sm:py-3 hover:opacity-90">
                    Find A Developer
                  </button>
                </div>
              </form>
